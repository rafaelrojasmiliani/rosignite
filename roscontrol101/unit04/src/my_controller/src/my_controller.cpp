...
#include <hardware_interface/joint_command_interface.h> // hardware_interface::EffortJointInterface
...
public:
   ...
   */
  bool init(hardware_interface::EffortJointInterface *_hardware_interface,
